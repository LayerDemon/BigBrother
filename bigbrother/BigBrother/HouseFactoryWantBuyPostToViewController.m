//
//  HouseFactoryWantBuyPostToViewController.m
//  BigBrother
//
...
@interface HouseFactoryWantBuyPostToViewController ()<CTAssetsPickerControllerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,UIScrollViewDelegate>

@end

@implementation HouseFactoryWantBuyPostToViewController{
...
-(void)uploadWithParams:(NSMutableDictionary *)paramsDic{
    ...
    double uploadstart = [[NSDate date] timeIntervalSince1970];
    if (paramsDic) {
        [paramsDic setObject:HouseProductFactoryRoomType_QiuGou forKey:@"postType"];
    }
