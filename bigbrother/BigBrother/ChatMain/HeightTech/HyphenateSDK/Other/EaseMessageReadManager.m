...
- (BOOL)prepareMessageAudioModel:(ChatMessageModel *)messageModel
                      updateViewCompletion:(void (^)(ChatMessageModel *prevAudioModel, ChatMessageModel *currentAudioModel))updateCompletion
{
    BOOL isPrepare = NO;
    
    if(messageModel.messageBodyType == EMMessageBodyTypeVoice)
    {
        ChatMessageModel *prevAudioModel = self.audioMessageModel;
        ChatMessageModel *currentAudioModel = messageModel;
...
- (ChatMessageModel *)stopMessageAudioModel
{
    ChatMessageModel *model = nil;
    if (self.audioMessageModel.messageBodyType == EMMessageBodyTypeVoice) {
