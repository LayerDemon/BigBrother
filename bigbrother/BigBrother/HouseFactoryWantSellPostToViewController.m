//
//  HouseFactoryWantSellPostToViewController.m
//  BigBrother
//
...
@interface HouseFactoryWantSellPostToViewController ()<CTAssetsPickerControllerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,UIScrollViewDelegate>

@end

@implementation HouseFactoryWantSellPostToViewController{
...
-(void)uploadWithParams:(NSMutableDictionary *)paramsDic{
    ...
    double uploadstart = [[NSDate date] timeIntervalSince1970];
    if (paramsDic) {
        [paramsDic setObject:HouseProductFactoryRoomType_ChuShou forKey:@"postType"];
    }
