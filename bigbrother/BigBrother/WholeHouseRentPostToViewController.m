//
//  WholeHouseRentViewController.m
//  BigBrother
//
...
@interface WholeHouseRentPostToViewController ()<CTAssetsPickerControllerDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIActionSheetDelegate,UIScrollViewDelegate>

@end

@implementation WholeHouseRentPostToViewController{
    ...
    //房屋所在楼层相关
    UIView *houseFloorView;
    UITextField *houseFloorTextfield;
    UITextField *houseTotalFloorTextfield;
    ...
    //房屋小区相关
    UIView *houseCommunityView;
    UITextField *houseCommunityNameTextfiled;
    UITextField *houseCommunityAddressTextfiled;
...
-(void)reloadViews{
    ...
    houseFloorView = [self setUpHouseFloorViewWithOffset:viewHeightOffset];
    [contentView addSubview:houseFloorView];
    
    viewHeightOffset += HEIGHT(houseFloorView);
    viewHeightOffset += 10;
    ...
    houseCommunityView = [self setUpHouseCommunityViewWithOffset:viewHeightOffset];
    [contentView addSubview:houseCommunityView];
    
    viewHeightOffset += HEIGHT(houseCommunityView);
...
-(void)postButtonClick{
    ...
    NSString *houseFloorString = houseFloorTextfield.text;
    NSString *houseTotalFloorString = houseTotalFloorTextfield.text;
    
    if (![XYTools checkString:houseFloorString canEmpty:NO]) {
        [BYToastView showToastWithMessage:@"所在楼层不能包含特殊字符"];
        return;
    }
    
    if (![XYTools checkString:houseTotalFloorString canEmpty:NO]) {
        [BYToastView showToastWithMessage:@"总楼层数不能包含特殊字符"];
        return;
    }
    ...
    NSString *communityName = houseCommunityNameTextfiled.text;
    if (![XYTools checkString:communityName canEmpty:NO]) {
        [BYToastView showToastWithMessage:@"小区名称不能包含特殊字符"];
        return;
    }
    NSString *communityAddress = houseCommunityAddressTextfiled.text;
    if (![XYTools checkString:communityAddress canEmpty:NO]) {
        [BYToastView showToastWithMessage:@"小区地址不能包含特殊字符"];
        return;
    }
    ...
    [paramsDic setObject:@(houseRoomTypeID) forKey:@"roomId"];
    [paramsDic setObject:houseAreaString forKey:@"area"];
    [paramsDic setObject:houseFloorString forKey:@"floor"];
    [paramsDic setObject:houseTotalFloorString forKey:@"totalFloor"];
    [paramsDic setObject:@(provideID) forKey:@"districtId"];
    [paramsDic setObject:communityName forKey:@"communityName"];
    [paramsDic setObject:communityAddress forKey:@"communityAddress"];
...
-(void)uploadWithParams:(NSMutableDictionary *)paramsDic{
    ...
    double uploadstart = [[NSDate date] timeIntervalSince1970];
    [BBUrlConnection uploadNewWholeHouseRentInfoWithParams:paramsDic complete:^(NSDictionary *resultDic, NSString *errorString) {
        double uploadend = [[NSDate date] timeIntervalSince1970];
        float delay = uploadend-uploadstart >5?0.2:5-(uploadend-uploadstart);
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(delay * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            [indicatorView stopAnimating:YES];
...
#pragma mark - 房屋楼层 view 及相关事件
-(UIView *)setUpHouseFloorViewWithOffset:(float)offset{
    UIView *view = [[UIView alloc] init];
    ...
    UILabel *unitNoteLabel1 = [[UILabel alloc] init];
    unitNoteLabel1.frame = (CGRect){WIDTH(view)-10-20,0,20,HEIGHT(noteLabel)};
    unitNoteLabel1.text = @"楼";
    unitNoteLabel1.textColor = RGBColor(50, 50, 50);
    unitNoteLabel1.textAlignment = NSTextAlignmentRight;
    unitNoteLabel1.font = Font(14);
    [view addSubview:unitNoteLabel1];
    
    houseFloorTextfield = [[UITextField alloc] init];
    houseFloorTextfield.frame = (CGRect){
        RIGHT(noteLabel)+10,
        0,
        WIDTH(view)-(RIGHT(noteLabel)+10)-WIDTH(unitNoteLabel1)-10,
        titleLineHeight
    };
    houseFloorTextfield.textColor = RGBColor(80, 80, 80);
    houseFloorTextfield.font = Font(15);
    houseFloorTextfield.textAlignment = NSTextAlignmentRight;
    houseFloorTextfield.minimumFontSize = 10;
    houseFloorTextfield.adjustsFontSizeToFitWidth = YES;
    houseFloorTextfield.returnKeyType = UIReturnKeyDone;
    houseFloorTextfield.keyboardType = UIKeyboardTypePhonePad;
    [houseFloorTextfield setAutocapitalizationType:UITextAutocapitalizationTypeNone];
    [houseFloorTextfield setAutocorrectionType:UITextAutocorrectionTypeNo];
    
    [houseFloorTextfield setLeftView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseFloorTextfield)}]];
    [houseFloorTextfield setRightView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseFloorTextfield)}]];
    houseFloorTextfield.leftViewMode = UITextFieldViewModeAlways;
    houseFloorTextfield.rightViewMode = UITextFieldViewModeAlways;
    
    [view addSubview:houseFloorTextfield];
    
    UILabel *noteLabel2 = [[UILabel alloc] init];
    noteLabel2.frame = (CGRect){10,titleLineHeight,65,titleLineHeight};
    noteLabel2.text = @"总楼层数";
    ...
    UILabel *unitNoteLabel2 = [[UILabel alloc] init];
    unitNoteLabel2.frame = (CGRect){
        WIDTH(view)-10-20,
        titleLineHeight,
        20,
        titleLineHeight};
    unitNoteLabel2.text = @"楼";
    unitNoteLabel2.textColor = RGBColor(50, 50, 50);
    unitNoteLabel2.textAlignment = NSTextAlignmentRight;
    unitNoteLabel2.font = Font(14);
    [view addSubview:unitNoteLabel2];
    
    houseTotalFloorTextfield = [[UITextField alloc] init];
    houseTotalFloorTextfield.frame = (CGRect){
        RIGHT(noteLabel2)+10,
        titleLineHeight,
        WIDTH(view)-(RIGHT(noteLabel)+10)-WIDTH(unitNoteLabel2)-10,
        titleLineHeight
    };
    houseTotalFloorTextfield.textColor = RGBColor(80, 80, 80);
    houseTotalFloorTextfield.font = Font(15);
    houseTotalFloorTextfield.textAlignment = NSTextAlignmentRight;
    houseTotalFloorTextfield.minimumFontSize = 10;
    houseTotalFloorTextfield.adjustsFontSizeToFitWidth = YES;
    houseTotalFloorTextfield.returnKeyType = UIReturnKeyDone;
    houseTotalFloorTextfield.keyboardType = UIKeyboardTypePhonePad;
    [houseTotalFloorTextfield setAutocapitalizationType:UITextAutocapitalizationTypeNone];
    [houseTotalFloorTextfield setAutocorrectionType:UITextAutocorrectionTypeNo];
    
    [houseTotalFloorTextfield setLeftView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseTotalFloorTextfield)}]];
    [houseTotalFloorTextfield setRightView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseTotalFloorTextfield)}]];
    houseTotalFloorTextfield.leftViewMode = UITextFieldViewModeAlways;
    houseTotalFloorTextfield.rightViewMode = UITextFieldViewModeAlways;
    
    [view addSubview:houseTotalFloorTextfield];
    ...
    lineSepView2.frame = (CGRect){0,titleLineHeight,WIDTH(view),0.5};
    [view addSubview:lineSepView2];
...
#pragma mark - 小区相关 view 及相关事件
-(UIView *)setUpHouseCommunityViewWithOffset:(float)offset{
    UIView *view = [[UIView alloc] init];
    view.frame = (CGRect){0,offset,WIDTH(contentView),titleLineHeight*2};
    view.backgroundColor = [UIColor whiteColor];
    ...
    houseCommunityNameTextfiled = [[UITextField alloc] init];
    houseCommunityNameTextfiled.frame = (CGRect){
        RIGHT(noteLabel)+10,
        0,
        WIDTH(view)-(RIGHT(noteLabel)+10)-10,
        titleLineHeight
    };
    houseCommunityNameTextfiled.textColor = RGBColor(80, 80, 80);
    houseCommunityNameTextfiled.font = Font(15);
    houseCommunityNameTextfiled.minimumFontSize = 10;
    houseCommunityNameTextfiled.adjustsFontSizeToFitWidth = YES;
    houseCommunityNameTextfiled.returnKeyType = UIReturnKeyDone;
    houseCommunityNameTextfiled.textAlignment = NSTextAlignmentRight;
    houseCommunityNameTextfiled.keyboardType = UIKeyboardTypeDefault;
    [houseCommunityNameTextfiled setAutocapitalizationType:UITextAutocapitalizationTypeNone];
    [houseCommunityNameTextfiled setAutocorrectionType:UITextAutocorrectionTypeNo];
    
    [houseCommunityNameTextfiled setLeftView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseCommunityNameTextfiled)}]];
    [houseCommunityNameTextfiled setRightView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseCommunityNameTextfiled)}]];
    houseCommunityNameTextfiled.leftViewMode = UITextFieldViewModeAlways;
    houseCommunityNameTextfiled.rightViewMode = UITextFieldViewModeAlways;
    
    [view addSubview:houseCommunityNameTextfiled];
    
    UILabel *noteLabel2 = [[UILabel alloc] init];
    noteLabel2.frame = (CGRect){10,titleLineHeight,65,titleLineHeight};
    noteLabel2.text = @"小区地址";
    noteLabel2.textColor = RGBColor(50, 50, 50);
    noteLabel2.textAlignment = NSTextAlignmentLeft;
    noteLabel2.font = [UIFont boldSystemFontOfSize:15];
    [view addSubview:noteLabel2];
    
    houseCommunityAddressTextfiled = [[UITextField alloc] init];
    houseCommunityAddressTextfiled.frame = (CGRect){
        RIGHT(noteLabel)+10,
        titleLineHeight,
        WIDTH(view)-(RIGHT(noteLabel)+10)-10,
        titleLineHeight
    };
    houseCommunityAddressTextfiled.textColor = RGBColor(80, 80, 80);
    houseCommunityAddressTextfiled.font = Font(15);
    houseCommunityAddressTextfiled.minimumFontSize = 10;
    houseCommunityAddressTextfiled.adjustsFontSizeToFitWidth = YES;
    houseCommunityAddressTextfiled.textAlignment = NSTextAlignmentRight;
    houseCommunityAddressTextfiled.returnKeyType = UIReturnKeyDone;
    houseCommunityAddressTextfiled.keyboardType = UIKeyboardTypeDefault;
    [houseCommunityAddressTextfiled setAutocapitalizationType:UITextAutocapitalizationTypeNone];
    [houseCommunityAddressTextfiled setAutocorrectionType:UITextAutocorrectionTypeNo];
    
    [houseCommunityAddressTextfiled setLeftView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseCommunityAddressTextfiled)}]];
    [houseCommunityAddressTextfiled setRightView:[[UIView alloc] initWithFrame:(CGRect){0,0,5,HEIGHT(houseCommunityAddressTextfiled)}]];
    houseCommunityAddressTextfiled.leftViewMode = UITextFieldViewModeAlways;
    houseCommunityAddressTextfiled.rightViewMode = UITextFieldViewModeAlways;
    
    [view addSubview:houseCommunityAddressTextfiled];
...
-(void)resignAllInputs{
    ...
    [houseFloorTextfield resignFirstResponder];
    [houseTotalFloorTextfield resignFirstResponder];
    [houseCommunityNameTextfiled resignFirstResponder];
    [houseCommunityAddressTextfiled resignFirstResponder];
